...
let numOfCircles = 33;
let bgImage
let bottomX = 110;  // 第一个半圆的 X 位置
let bottomY = 495;      // 半圆的 Y 位置
let diameter1 = 35; // 每个半圆的直径
...
[210,289],[200,340],[202,385],[208,410],[200,433]
];
...
function draw() {
  background(bgImage);
    ...
    stroke(217, 194, 125)
    strokeWeight(2);
    arc(285,495,20,35,PI,0,fill(228, 102, 103))
